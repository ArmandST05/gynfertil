...
$sql = "SELECT id, name, type_id,minimum_inventory FROM products WHERE type_id='4' AND is_active = '1' ";
...
if (!empty($requestData['search']['value'])) {
	...
	$sql .= " FROM products";
	$sql .= " WHERE type_id='4' AND is_active = '1' ";
...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	$nestedData[] = '<p style="background-color:'.$color.'">MEDICAMENTO/PRODUCTO</p>';
	...
	$nestedData[] =  '<td>
		       				...
		       				<a href="index.php?view=inventory/history&id=' . $row["id"] . '&branchOfficeId='.$searchBranchOfficeId.'" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-pencil"></i>Historial</a>
		     	     </td>';
