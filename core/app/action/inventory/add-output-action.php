	...
	$cart = $_SESSION["cartOutputs"];
		...
		if($process == true){
			...
			$operation->description = $_POST["description"];
 		    $output = $operation->addOutputInventory();
		...
		//print "<script>window.location='index.php?view=inventory/index-outputs&searchBranchOfficeId=".$_POST["branchOfficeId"]."';</script>";
	}
