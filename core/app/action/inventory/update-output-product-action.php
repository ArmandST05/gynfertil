<?php
$operationDetails = OperationPaymentData::getByOperationId($_POST["operationId"]);
$num_succ = 0;
$process=false;
$errors = array();

	$quantity = OperationDetailData::getStockByBranchOfficeProduct($_POST["branchOfficeId"],$_POST["productId"]);
