...
$sql = "SELECT id, barcode, name, price_in, price_out, minimum_inventory, is_active_user  FROM products WHERE type_id='4' AND is_active = '1'";
...
if(!empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT id,barcode, name, price_in, price_out, minimum_inventory, is_active_user ";
	$sql.=" FROM products";
	$sql.=" WHERE type_id = '4' ";
	$sql.=" AND is_active = '1' ";
