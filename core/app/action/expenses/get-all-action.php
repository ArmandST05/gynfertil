...
if (!empty($requestData['search']['value'])) {
    ...
    $sql .= " WHERE operation_type_id = '1' AND operation_category_id = '3' AND o.branch_office_id = '$searchBranchOfficeId' ";
...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
    ...
    $nestedData[] = '<td>$' . (isset($totalPayment->total) ? number_format($totalPayment->total, 2):"0.00") . '</td>';
