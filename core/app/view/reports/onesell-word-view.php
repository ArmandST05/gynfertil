...
if($sell->idPac!=null){ $client = PatientData::getById1($sell->idPac);}
$user = $sell->getUser();

$section1 = $word->AddSection();
$section1->addImage(
    ROOT.'/assets/clinic-logo.png',
    array(
        'width' => 160,
        'height' => 75,
...
$table2->addCell()->addText("$".number_format($operation->q*$operation->price,2,".",","));
...
//$table4->addCell(3000)->addText("Subtotal: $".number_format($totalPay*0.84,2,".",","),array("size"=>10, "bold"  => true));
$table4->addCell(3000)->addText("Subtotal: $".number_format($total,2,".",","),array("size"=>10, "bold"  => true));

$table4->addRow();
$table4->addCell()->addText();$table4->addCell(3800)->addText();$table4->addCell(3800)->addText();
$table4->addCell(3000)->addText("Total: $".number_format($total,2,".",","),array("size"=>10, "bold"  => true));

/*$table4->addRow();
$table4->addCell()->addText();$table4->addCell(3800)->addText();$table4->addCell(3800)->addText();
$table4->addCell(3000)->addText("Cambio: $".number_format($totalPay-$total,2,".",","),array("size"=>10, "bold"  => true));*/
...
$table3->addCell()->addText("$".number_format($pay->cash,2,".",","));
