...
if ($userType == "su") {
  $branchOfficeId = isset($_GET["branchOfficeId"]) ? $_GET["branchOfficeId"] : null;
  if ($branchOfficeId) {
    $_SESSION["expense-branchOffice"] = $branchOfficeId;
  }
}
?>
...
<div class="row">
  <div class="col-md-12">
    <h1>Gastos</h1>
    <?php if ($userType == "su" && !isset($_SESSION["expense-branchOffice"])) : ?>
      <h4>No se ha asignado una sucursal. Vuelve a crear el gasto desde el menú principal</h4>
    <?php endif; ?>
