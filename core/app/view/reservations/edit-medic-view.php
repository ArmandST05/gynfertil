        ...
        <form class="form-horizontal" method="POST" action="./?action=reservations/update-reservation-medic" role="form">
          <div class="form-group ">
            <div class="col-lg-3">
              ...
              <input type="date" name="date" id="formfecha" class="form-control" <?php echo ($userType != "su") ? "min='".date('Y-m-d')."'":""?> value="<?php echo $reservation->getDate() ?>">
            </div>
            ...
            <div class="col-lg-5">
              <label for="inputEmail1" class="col-lg-3 control-label">Psicólogo</label>
