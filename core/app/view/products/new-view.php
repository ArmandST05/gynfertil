    ...
    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="index.php?action=products/add" role="form" autocomplete="off">
      ...
      <div style="display:none;" id="productDetails">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="number" step=".1" min="0" name="minimumInventory" class="form-control" id="inputEmail1" placeholder="Mínimo en Inventario (Predeterminada 10)">
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail1" class="col-lg-2 control-label">Inventario inicial:</label>
          <div class="col-md-6">
            <input type="number" step=".01" min="0" name="initialInventory" class="form-control" id="inputEmail1" placeholder="Inventario inicial">
          </div>
        </div>
        <div class="form-group">
