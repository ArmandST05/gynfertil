      ...
      <div class="col-md-6">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-183" name="details[183]" class="form-control" placeholder="" value="<?php echo $procedureDetails['183'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Recolección:</label>
            <input type="text" id="dt-184" name="details[184]" class="form-control" placeholder="" value="<?php echo $procedureDetails['184'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Procesamiento:</label>
            <input type="text" id="dt-185" name="details[185]" class="form-control" placeholder="" value="<?php echo $procedureDetails['185'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Donante:</label>
            <input type="text" id="dt-186" name="details[186]" class="form-control" placeholder="" value="<?php echo $procedureDetails['186'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
    ...
    <form method="POST" action="index.php?action=andrology-procedures/updateProcedure" role="form" id="formUpdateProcedureDetails">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-187" name="details[187]" class="form-control" placeholder="" value="<?php echo $procedureDetails['187'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-188" name="details[188]" class="form-control" placeholder="" value="<?php echo $procedureDetails['188'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-189" name="details[189]" class="form-control" placeholder="" value="<?php echo $procedureDetails['189'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-190" name="details[190]" class="form-control" placeholder="" value="<?php echo $procedureDetails['190'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-191" name="details[191]" class="form-control" placeholder="" value="<?php echo $procedureDetails['191'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-192" name="details[192]" class="form-control" placeholder="" value="<?php echo $procedureDetails['192'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
    ...
    <form method="POST" action="index.php?action=andrology-procedures/updateProcedure" role="form" id="formUpdateProcedureDetails">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-193" name="details[193]" class="form-control" placeholder="" value="<?php echo $procedureDetails['193'] ?>">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-194" name="details[194]" class="form-control" placeholder="" value="<?php echo $procedureDetails['194'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶ </span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-195" name="details[195]" class="form-control" placeholder="" value="<?php echo $procedureDetails['195'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶ /mL</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-196" name="details[196]" class="form-control" placeholder="" value="<?php echo $procedureDetails['196'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶ /mL</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-197" name="details[197]" class="form-control" placeholder="" value="<?php echo $procedureDetails['197'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-198" name="details[198]" class="form-control" placeholder="" value="<?php echo $procedureDetails['198'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <br>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-199" name="details[199]" class="form-control" placeholder="" value="<?php echo $procedureDetails['199'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-200" name="details[200]" class="form-control" placeholder="" value="<?php echo $procedureDetails['200'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-201" name="details[201]" class="form-control" placeholder="" value="<?php echo $procedureDetails['201'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-202" name="details[202]" class="form-control" placeholder="" value="<?php echo $procedureDetails['202'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-203" name="details[203]" class="form-control" placeholder="" value="<?php echo $procedureDetails['203'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-204" name="details[204]" class="form-control" placeholder="" value="<?php echo $procedureDetails['204'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-205" name="details[205]" class="form-control" placeholder="" value="<?php echo $procedureDetails['205'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="input-group">
            <input type="text" id="dt-206" name="details[206]" class="form-control" placeholder="" value="<?php echo $procedureDetails['206'] ?>">
            <div class="input-group-addon">
              <span>x 10⁶ /mL</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Espermatozoides Normales (%):</label>
          <div class="input-group">
            <input type="text" id="dt-207" name="details[207]" class="form-control" placeholder="" value="<?php echo $procedureDetails['207'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Espermatozoides Anormales (%):</label>
          <div class="input-group">
            <input type="text" id="dt-208" name="details[208]" class="form-control" placeholder="" value="<?php echo $procedureDetails['208'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Defectos de Cabeza (%):</label>
          <div class="input-group">
            <input type="text" id="dt-209" name="details[209]" class="form-control" placeholder="" value="<?php echo $procedureDetails['209'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Defectos de Pieza Media (%):</label>
          <div class="input-group">
            <input type="text" id="dt-210" name="details[210]" class="form-control" placeholder="" value="<?php echo $procedureDetails['210'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Defectos de Cola (%):</label>
          <div class="input-group">
            <input type="text" id="dt-211" name="details[211]" class="form-control" placeholder="" value="<?php echo $procedureDetails['211'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <label for="inputEmail1" class="control-label">Residuo Citoplasmático (%):</label>
          <div class="input-group">
            <input type="text" id="dt-212" name="details[212]" class="form-control" placeholder="" value="<?php echo $procedureDetails['212'] ?>">
            <div class="input-group-addon">
              <span>%</span>
            </div>
          </div>
