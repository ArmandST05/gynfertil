...
try {
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">CAPACITACIÓN ESPERMÁTICA</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="patient-data" width="70px">' . $procedureDetails['276'] . '</td>
            <td>Recolección:</td>
            <td class="patient-data" width="70px">' . $procedureDetails['277'] . '</td>
            <td>Procesamiento:</td>
            <td class="patient-data" width="70px">' . $procedureDetails['278'] . '</td>
            <td>Procedencia:</td>
            <td class="patient-data" width="70px">' . $procedureDetails['313'] . '</td>
        </tr>
        <tr>
            <td>Código congelación:</td>
            <td class="patient-data" width="70px">' . $procedureDetails['314'] . '</td>
            <td>Cantidad de dispositivos:</td>
            <td class="patient-data" width="70px">' . $procedureDetails['315'] . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
...
<tr>
    ...
    <tr>
        ...
        <td class="center bold" width="100px" colspan="2">RESULTADO MUESTRA CAPACITADA </td>
        <td class="bold" colspan="2">VALORES DE REFERENCIA OMS 2021</td>
        <td></td>
    </tr> 
    <tr>
        <td class="content-title">Concentración (mill/mL):</td>
        <td class="underlined center" width="60px">' . $procedureDetails['285'] . '</td>
        <td class="underlined center" width="60px"> x 10⁶ /mL</td>
        <td class="underlined center" width="60px">' . $procedureDetails['286'] . '</td>
        <td class="underlined center" width="60px"> x 10⁶ /mL</td>
    ...
    <tr>
        ...
        <td class="underlined center">' . $procedureDetails['287'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="underlined center">' . $procedureDetails['288'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="bold">≥ 39 x 10⁶</td>
    </tr>
    <tr>
        <td class="content-title">Células redondas (mill/mL):</td>
        <td class="underlined center">' . $procedureDetails['289'] . '</td>
        <td class="underlined center">x 10⁶ /mL</td>
        <td class="underlined center">' . $procedureDetails['290'] . '</td>
        <td class="underlined center">x 10⁶ /mL</td>
        <td class="bold">≤ 1 x 10⁶/ mL</td>
    </tr>
    <tr>
        <td class="content-title">Leucocitos:</td>
        <td class="underlined center">' . $procedureDetails['291'] . '</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td class="underlined center">' . $procedureDetails['292'] . '</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td class="bold">≤ 1 x 10⁶/ mL</td>
    </tr>
    <tr>
        <td class="content-title">Aglutinación:</td>
        <td class="underlined center">' . $procedureDetails['293'] . '</td>
        <td class="underlined center"></td>
        <td class="underlined center">' . $procedureDetails['294'] . '</td>
        <td class="underlined center"></td>
        <td class="bold">Negativa</td>
    </tr>
    <tr>
        <td class="content-title">Otros:</td>
        <td class="underlined center">' . $procedureDetails['295'] . '</td>
        <td class="underlined center"></td>
        <td class="underlined center">' . $procedureDetails['296'] . '</td>
        <td class="underlined center"></td>
        <td></td>
    </tr>
    <tr>
        <td class="content-title">Movilidad Progresiva (PR):</td>
        <td class="underlined center">' . $procedureDetails['297'] . '</td>
        <td class="underlined center">%</td>
        <td class="underlined center">' . $procedureDetails['298'] . '</td>
        <td class="underlined center">%</td>
        <td class="bold">≥ 30 % </td>
    </tr>
    <tr>
        <td class="content-title">Movilidad No Progresiva (NP):</td>
        <td class="underlined center">' . $procedureDetails['299'] . '</td>
        <td class="underlined center">%</td>
        <td class="underlined center">' . $procedureDetails['300'] . '</td>
        <td class="underlined center">%</td>
        <td class="bold">(NP) ≥ 1</td>
    </tr>
    <tr>
        <td class="content-title">Inmóviles (IM):</td>
        <td class="underlined center">' . $procedureDetails['301'] . '</td>
        <td class="underlined center">%</td>
        <td class="underlined center">' . $procedureDetails['302'] . '</td>
        <td class="underlined center">%</td>
        <td class="bold">(IM) ≤ 20% </td>
    </tr>
    <tr>
        <td class="content-title">Espermatozoides PR Totales (mill):</td>
        <td class="underlined center">' . $procedureDetails['303'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="underlined center">' . $procedureDetails['304'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="bold">(PR+NP) ≥ 42%</td>
    </tr>
    <tr>
        <td class="content-title">Vitalidad:</td>
        <td class="underlined center">' . $procedureDetails['305'] . '</td>
        <td class="underlined center">%</td>
        <td class="underlined center">' . $procedureDetails['306'] . '</td>
        <td class="underlined center">%</td>
        <td class="bold">≥ 54 % </td>
        <td rowspan="9"><img width="150px" height="150px" src="' . $lens100xImage . '" /></td>
    </tr>
    <tr>
        <td class="content-title">Espermatozoides No Vitales:</td>
        <td class="underlined center">' . $procedureDetails['307'] . '</td>
        <td class="underlined center">%</td>
        <td class="underlined center">' . $procedureDetails['308'] . '</td>
        <td class="underlined center">%</td>
        <td></td>
    </tr>
    <tr>
        <td class="content-title">Total espermatozoides vitales (mill):</td>
        <td class="underlined center">' . $procedureDetails['309'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="underlined center">' . $procedureDetails['310'] . '</td>
        <td class="underlined center"> x 10⁶ </td>
        <td></td>
    </tr>
    <tr>
        <td class="content-title">REM*:</td>
        <td class="underlined center">' . $procedureDetails['311'] . '</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td class="underlined center">' . $procedureDetails['312'] . '</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td></td>
    </tr>
    <!--<tr>
        <td class="content-title">Volumen a transferir:</td>
        <td class="underlined center">'.$procedureDetails['529'].'</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        <td class="content-title">Técnica de capacitación:</td>
        <td class="underlined center">'.$procedureDetails['530'].'</td>
        <td></td>
        <td></td>
    </tr>-->
</table>
