...
try {
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">INSEMINACIÓN HOMÓLOGA</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td class="patient-data" width="70px">'.$procedureDetails['318'].'</td>
            <td>Recolección:</td>
            <td class="patient-data" width="70px">'.$procedureDetails['319'].'</td>
            <td>Procesamiento:</td>
            <td class="patient-data" width="70px">'.$procedureDetails['320'].'</td>
            <td>Procedencia:</td>
            <td class="patient-data" width="70px">'.$procedureDetails['321'].'</td>
        </tr>
        <tr>
            <td>Código congelación:</td>
            <td class="patient-data" width="70px">'.$procedureDetails['322'].'</td>
            <td>Cantidad de dispositivos:</td>
            <td class="patient-data" width="70px">'.$procedureDetails['323'].'</td>
        </tr>
    </table>
    <br>
    <table width="100%">
...
<tr>
    ...
    <tr>
        <td width="200px"></td>
        <td class="center bold" width="100px" colspan="2">RESULTADO MUESTRA INICIAL</td>
        <td width="30px"></td>
        <td class="center bold" width="150px" colspan="2">RESULTADO MUESTRA CAPACITADA </td>
        <td class="bold" width="50px" colspan="2">VALORES DE REFERENCIA OMS 2021</td>
        <td></td>
    </tr> 
    <tr>
        <td class="content-title">Concentración (mill/mL):</td>
        <td class="underlined center" width="60px">'.$procedureDetails['330'].'</td>
        <td class="underlined center" width="60px"> x 10⁶ /mL</td>
        <td width="30px"></td>
        <td class="underlined center" width="60px">'.$procedureDetails['331'].'</td>
        <td class="underlined center" width="60px"> x 10⁶ /mL</td>
    ...
    <tr>
        ...
        <td class="underlined center">'.$procedureDetails['332'].'</td>
        <td class="underlined center"> x 10⁶ </td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['333'].'</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="bold">≥ 39 x 10⁶</td>
    </tr>
    <tr>
        <td class="content-title">Células redondas (mill/mL):</td>
        <td class="underlined center">'.$procedureDetails['334'].'</td>
        <td class="underlined center">x 10⁶ /mL</td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['335'].'</td>
        <td class="underlined center">x 10⁶ /mL</td>
        <td class="bold">≤ 1 x 10⁶/ mL</td>
    </tr>
    <tr>
        <td class="content-title">Leucocitos:</td>
        <td class="underlined center">'.$procedureDetails['336'].'</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['337'].'</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td class="bold">≤ 1 x 10⁶/ mL</td>
    </tr>
    <tr>
        <td class="content-title">Aglutinación:</td>
        <td class="underlined center">'.$procedureDetails['338'].'</td>
        <td class="underlined center"></td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['339'].'</td>
        <td class="underlined center"></td>
        <td class="bold">Negativa</td>
    </tr>
    <tr>
        <td class="content-title">Otros:</td>
        <td class="underlined center">'.$procedureDetails['340'].'</td>
        <td class="underlined center"></td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['341'].'</td>
        <td class="underlined center"></td>
        <td></td>
    </tr>
    <tr>
        <td class="content-title">Movilidad Progresiva (PR):</td>
        <td class="underlined center">'.$procedureDetails['342'].'</td>
        <td class="underlined center">%</td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['343'].'</td>
        <td class="underlined center">%</td>
        <td class="bold">≥ 30 % </td>
    </tr>
    <tr>
        <td class="content-title">Movilidad No Progresiva (NP):</td>
        <td class="underlined center">'.$procedureDetails['344'].'</td>
        <td class="underlined center">%</td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['345'].'</td>
        <td class="underlined center">%</td>
    ...
    <tr>
        ...
        <td class="underlined center">'.$procedureDetails['346'].'</td>
        <td class="underlined center">%</td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['347'].'</td>
        <td class="underlined center">%</td>
        <td class="bold">(IM) ≤ 20% </td>
    </tr>
    <tr>
        <td class="content-title">Espermatozoides PR Totales (mill):</td>
        <td class="underlined center">'.$procedureDetails['348'].'</td>
        <td class="underlined center"> x 10⁶ </td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['349'].'</td>
        <td class="underlined center"> x 10⁶ </td>
        <td class="bold">(PR+NP) ≥ 42%</td>
    </tr>
    <tr>
        <td class="content-title">Vitalidad:</td>
        <td class="underlined center">'.$procedureDetails['350'].'</td>
        <td class="underlined center">%</td>
        <td width="30px"></td>
        <!--<td class="underlined center">'.$procedureDetails['351'].'</td>
        <td class="underlined center">%</td>-->
        <td></td><td></td>
        <td class="bold">≥ 54 % </td>
    </tr>
    <tr>
        ...
        <td class="underlined center">'.$procedureDetails['352'].'</td>
        <td class="underlined center">%</td>
        <td width="30px"></td>
        <!--<td class="underlined center">'.$procedureDetails['353'].'</td>
        <td class="underlined center">%</td>-->
        <td></td>
    </tr>
    <tr>
        <td class="content-title">Total espermatozoides vitales (mill):</td>
        <td class="underlined center">'.$procedureDetails['354'].'</td>
        <td class="underlined center"> x 10⁶ </td>
        <td width="30px"></td>
        <!--<td class="underlined center">'.$procedureDetails['355'].'</td>
        <td class="underlined center"> x 10⁶ </td>-->
        <td></td>
    </tr>
    <tr>
        <td class="content-title">REM*:</td>
        <td class="underlined center">'.$procedureDetails['356'].'</td>
        <td class="underlined center"> x 10⁶ /mL</td>
        <td width="30px"></td>
        <!--<td class="underlined center">'.$procedureDetails['357'].'</td>
        <td class="underlined center"> x 10⁶ /mL</td>-->
        <td></td>
    </tr>
    <tr>
        ...
        <td class="underlined center"></td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['525'].'</td>
        <td></td>
        <td></td>
    </tr>
    <tr>
        ...
        <td class="underlined center"></td>
        <td width="30px"></td>
        <td class="underlined center">'.$procedureDetails['526'].'</td>
        <td></td>
        <td></td>
    </tr>
</table>
