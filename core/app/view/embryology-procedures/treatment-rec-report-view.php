...
try {
    ...
    <table width="100%">
        <tr>
            ...
            <td class="title-document">RECEPTORA DE EMBRIONES CONGELADOS <br>' . $embryologyProcedure->treatment_code . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
    ...
    $femaleConsent = (($procedureDetails['58'] == 1) ? "Sí" : "No");
    $maleConsent = (($procedureDetails['59'] == 1) ? "Sí" : "No");
    $html .= '
    <tr>
    <td>' . $actualCycle . '</td>
    <td>' . $embryologyProcedure->getDateMonthFormat($procedureDetails['53']) . '</td>
    <td>' . $procedureDetails['54'] . '</td>
    <td>' . $procedureDetails['55'] . '</td>
    <td>' . $femaleConsent . '</td>
</tr>
<tr class="title">
...
<td>' . $procedureDetails['76'] . '</td>
<td>' . $procedureDetails['182'] . '</td>
<td>' . $maleConsent . '</td>
</tr>
<tr class="title">
...
<tr>
<td>' . $procedureDetails['60'] . '</td>
<td>' . $procedureDetails['61'] . '</td>
<td>' . $procedureDetails['62'] . '</td>
<td>' . $procedureDetails['63'] . '</td>
<td>' . $procedureDetails['64'] . '</td>
</tr>
<tr>
...
<tr>
<td>' . $procedureDetails['65'] . '</td>
<td>' . $procedureDetails['66'] . '</td>
</tr>
</table>
    <br>
    ...
    foreach ($sections as $section) {
        $html .= '<th colspan="' . $section->total_section_details . '">' . $section->name . '<br>' . calculateSectionDate($section->day_number, 53) . '</th>';
    }
