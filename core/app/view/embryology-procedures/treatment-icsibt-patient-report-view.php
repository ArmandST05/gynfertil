...
try {
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['495']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">ICSI CON BIOPSIA TESTICULAR</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">ASPIRACIÓN FOLICULAR <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['130']) . ')</span></th>
        <td rowspan="5">';
    ...
    $html .= '</td></tr> 
        <tr>
            ...
            <td width="150px" class="underlined center">' . $procedureDetails['137'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MI:</td>
            <td class="underlined center">' . $procedureDetails['138'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MII:</td>
            <td class="underlined center">' . $procedureDetails['139'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en VG:</td>
            <td class="underlined center">' . $procedureDetails['140'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Degenerados:</td>
            <td class="underlined center">' . $procedureDetails['141'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">FERTILIZACIÓN <span class="date-title">(' . calculateSectionDate(1,130) . ')</span></th>
    <td rowspan="7">';
    ...
    <tr>
        ...
        <td  width="150px" class="underlined center">' . $procedureDetails['142'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Óvulos fertilizados:</td>
        <td class="underlined center">' . $procedureDetails['143'] . '</td>
    </tr>
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 3 <span class="date-title">(' . calculateSectionDate(3,130) . ')</span></th>
</tr>
    <tr>
        <td width="200px" class="content-title">Embriones calidad A:</td>
        <td  width="150px" class="underlined center">' . $procedureDetails['483'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad B:</td>
        <td class="underlined center">' . $procedureDetails['484'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad C:</td>
        <td class="underlined center">' . $procedureDetails['485'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad D:</td>
        <td class="underlined center">' . $procedureDetails['486'] . '</td>
    </tr>
</table>
<table width="100%">
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 5 <span class="date-title">(' . calculateSectionDate(5,130) . ')</span></th>
    <td rowspan="9">';
    ...
    <tr>
        ...
        <td width="150px" class="underlined center">' . $procedureDetails['487'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['488'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['489'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['490'] . '</td>
    </tr>
    <tr>
        <th class="title" colspan="3">EVALUACIÓN DÍA 6 Y 7 <span class="date-title">(' . calculateSectionDate(6,130) .' - '.calculateSectionDate(7,130) . ')</span></th>
    </tr>
    <tr>
        <td width="200px" class="content-title">Blastocistos:</td>
        <td width="150px" class="underlined center">' . $procedureDetails['491'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['492'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['493'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['494'] . '</td>
    </tr>
</table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['496'] . '</td>
</tr>
</table>
