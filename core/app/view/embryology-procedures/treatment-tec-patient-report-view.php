...
try {
    ...
    $transferDetail = EmbryologyProcedureTransferData::getByTreatmentId($_GET["id"]);
    ...
    $selectedImagesPath = [];
    $selectedOvulesImages = explode(",", $procedureDetails['456']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">TRANSFERENCIA DE EMBRIONES CONGELADOS</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">DESCONGELACIÓN DE EMBRIONES <span class="date-title">' . ConfigurationData::getDateFormat($procedureDetails['50']) . '</span></th>
        <td rowspan="3">';
    ...
    $html .= '</td></tr> 
        <tr>
            <td width="200px" class="content-title">Embriones descongelados:</td>
            <td width="150px" class="underlined center">' . $procedureDetails['458'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Día de cultivo:</td>
            <td class="underlined center">' . $procedureDetails['454'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Calidad embrionaria:</td>
            <td class="underlined center">' . $procedureDetails['459'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Embriones sobrantes:</td>
            <td class="underlined center">' . $procedureDetails['460'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">TRANSFERENCIA DE EMBRIONES <span class="date-title">' . ConfigurationData::getDateFormat($transferDetail->date) . '</span> </th>
    <td rowspan="3">';
    ...
    $html .= '</td></tr> 
    <tr>
        <td width="200px" class="content-title">Embriones transferidos:</td>
        <td width="150px" class="underlined center">' . $transferDetail->total . '</td>
        <td width="150px"></td>
    </tr> 
    <tr>
    <td width="200px" class="content-title">Días de cultivo:</td>
    <td class="underlined center">' . $procedureDetails['455'] . '</td>
    </tr>
    <tr>
    <td width="200px" class="content-title">Calidad embrionaria:</td>
    <td class="underlined center">' . $transferDetail->quality . '</td>
    </tr>
    </table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">'  . $procedureDetails['457'] . '</td>
</tr>
</table>
