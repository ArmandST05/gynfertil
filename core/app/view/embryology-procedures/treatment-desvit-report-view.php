...
try {
    ...
    $treatmentDiagnostics = TreatmentDiagnosticData::getByTreatmentString($embryologyProcedureId);
    ...
    <table width="100%">
        <tr>
            ...
            <td class="title-document">DESVITRIFICACIÓN DE ÓVULOS <br>' . $embryologyProcedure->treatment_code . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
    ...
    <tr class="title">
        <th>Ciclo</th>
        <th>Fecha desvitrificación óvulos</th>
        <th>Beta Hcg</th>
        <th>Consentimiento femenino</th>
        <th>Consentimiento masculino</th>
    </tr>';
    $femaleConsent = (($procedureDetails['121'] == 1) ? "Sí" : "No");
    $maleConsent = (($procedureDetails['122'] == 1) ? "Sí" : "No");
    $html .= '
    <tr>
    <td>' . $actualCycle . '</td>
    <td>' . $embryologyProcedure->getDateMonthFormat($procedureDetails['117']) . '</td>
    <td>' . $procedureDetails['118'] . '</td>
    <td>' . $femaleConsent . '</td>
    <td>' . $maleConsent . '</td>
</tr>
<tr class="title">
    <th colspan="3">Diagnóstico</th>
    <th colspan="2">Código de ciclo de vitrificación de óvulos</th>
</tr>
<tr>
<td colspan="3">' . $treatmentDiagnostics . '</td>
<td colspan="2">' . $procedureDetails['123'] . '</td>
</tr>
<tr class="title">
...
<tr>
    <th class="title">Óvulos descongelados</th>
    <th class="title">Degenerado</th>
    <th class="title">Fecundación-Ovocitos inseminados</th>
    <th class="title">Fecundación-Fertilizados</th>
</tr>
<tr>
<td>' . $procedureDetails['124'] . '</td>
<td>' . $procedureDetails['125'] . '</td>
<td>' . $procedureDetails['126'] . '</td>
<td>' . $procedureDetails['127'] . '</td>
</tr>
</table>
    <br>
    ...
    foreach ($sections as $section) {
        $html .= '<th colspan="' . $section->total_section_details . '">' . $section->name . '<br>' . calculateSectionDate($section->day_number, 117) . '</th>';
    }
