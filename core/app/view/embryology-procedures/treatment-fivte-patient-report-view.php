...
try {
    ...
    //Validar que se ha subido una firma del embriólogo
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['410']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">FERTILIZACIÓN IN VITRO</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">ASPIRACIÓN FOLICULAR <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['2']) . ')</span></th>
        <td rowspan="5">';
    ...
    $html .= '</td></tr> 
        <tr>
            ...
            <td width="150px" class="underlined center">' . $procedureDetails['10'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MI:</td>
            <td class="underlined center">' . $procedureDetails['11'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MII:</td>
            <td class="underlined center">' . $procedureDetails['12'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en VG:</td>
            <td class="underlined center">' . $procedureDetails['13'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Degenerados:</td>
            <td class="underlined center">' . $procedureDetails['14'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">FERTILIZACIÓN <span class="date-title">(' . calculateSectionDate(1, 2) . ')</span></th>
    <td rowspan="7">';
    ...
    <tr>
        ...
        <td  width="150px" class="underlined center">' . $procedureDetails['15'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Óvulos fertilizados:</td>
        <td class="underlined center">' . $procedureDetails['16'] . '</td>
    </tr>
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 3 <span class="date-title">(' . calculateSectionDate(3, 2) . ')</span></th>
</tr>
    <tr>
        <td width="200px" class="content-title">Embriones calidad A:</td>
        <td  width="150px" class="underlined center">' . $procedureDetails['398'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad B:</td>
        <td class="underlined center">' . $procedureDetails['399'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad C:</td>
        <td class="underlined center">' . $procedureDetails['400'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad D:</td>
        <td class="underlined center">' . $procedureDetails['401'] . '</td>
    </tr>
</table>
<table width="100%">
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 5 <span class="date-title">(' . calculateSectionDate(5, 2) . ')</span></th>
    <td rowspan="9">';
    ...
    <tr>
        ...
        <td width="150px" class="underlined center">' . $procedureDetails['402'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['403'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['404'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['405'] . '</td>
    </tr>
    <tr>
        <th class="title" colspan="3">EVALUACIÓN DÍA 6 Y 7 <span class="date-title">(' . calculateSectionDate(6, 2) . ' - ' . calculateSectionDate(7, 2) . ')</span></th>
    </tr>
    <tr>
        <td width="200px" class="content-title">Blastocistos:</td>
        <td width="150px" class="underlined center">' . $procedureDetails['406'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['407'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['408'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['409'] . '</td>
    </tr>
</table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['411'] . '</td>
</tr>
</table>
