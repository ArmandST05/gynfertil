...
try {
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['481']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">DONACIÓN DE EMBRIONES</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">DESCONGELACIÓN DE EMBRIONES</th>
        <td rowspan="3">';
    ...
    $html .= '</td></tr> 
        <tr>
            ...
            <td width="150px" class="underlined center">' . $procedureDetails['475'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Día de cultivo:</td>
            <td class="underlined center">' . $procedureDetails['476'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Calidad embrionaria:</td>
            <td class="underlined center">' . $procedureDetails['477'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">TRANSFERENCIA DE EMBRIONES</th>
    <td rowspan="3">';
    ...
    <tr>
        ...
        <td width="150px" class="underlined center">' . $procedureDetails['478'] . '</td>
        <td width="150px"></td>
    </tr> 
    <tr>
    <td width="200px" class="content-title">Días de cultivo:</td>
    <td class="underlined center">' . $procedureDetails['479'] . '</td>
    </tr>
    <tr>
    <td width="200px" class="content-title">Calidad embrionaria:</td>
    <td class="underlined center">' . $procedureDetails['480'] . '</td>
    </tr>
    </table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['482'] . '</td>
</tr>
</table>
