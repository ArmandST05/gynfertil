...
try {
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['461']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">VITRIFICACIÓN DE ÓVULOS</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">ASPIRACIÓN FOLICULAR <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['31']) . ')</span></th>
        <td rowspan="5">';
    ...
    $html .= '</td></tr> 
        <tr>
            ...
            <td width="150px" class="underlined center">' . $procedureDetails['34'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MI:</td>
            <td class="underlined center">' . $procedureDetails['36'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MII:</td>
            <td class="underlined center">' . $procedureDetails['37'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en VG:</td>
            <td class="underlined center">' . $procedureDetails['38'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Degenerados:</td>
            <td class="underlined center">' . $procedureDetails['39'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">VITRIFICACIÓN DE ÓVULOS <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['40']) . ')</span></th>
    <td rowspan="5">';
    ...
    <tr>
        ...
        <td  width="150px" class="underlined center">' . $procedureDetails['48'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="underlined center">' . $procedureDetails['45'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Cesta:</td>
        <td class="underlined center">' . $procedureDetails['44'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Varilla:</td>
        <td class="underlined center">' . $procedureDetails['497'] . '</td>
    </tr>
</table>
<table width="100%">
<tr>
    ...
    <tr>
        ...
        <td width="150px" class="underlined center">' . $embryologyProcedure->treatment_code . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Número de dispositivos:</td>
        <td class="underlined center">' . $procedureDetails['43'] . '</td>
    </tr>
</table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['524'] . '</td>
</tr>
</table>
