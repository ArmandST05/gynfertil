...
try {
    ...
    <table width="100%">
        <tr>
            ...
            <td class="title-document">ICSI CON BIOPSIA TESTICULAR <br>' . $embryologyProcedure->treatment_code . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
    ...
    <td>' . $embryologyProcedure->getDateMonthFormat($procedureDetails['130']) . '</td>
    <td>' . $procedureDetails['131'] . '</td>
    <td>' . $procedureDetails['146'] . '</td>
</tr>
<tr class="title">
    <th>Beta Hcg</th>
...
<tr>
<td>' . $procedureDetails['132'] . '</td>';
    $femaleConsent = (($procedureDetails['135'] == 1) ? "Sí" : "No");
    $maleConsent = (($procedureDetails['136'] == 1) ? "Sí" : "No");
...
<tr>
<td>' . $procedureDetails['147'] . '</td>
<td>' . $procedureDetails['137'] . '</td>
<td>' . $procedureDetails['138'] . '</td>
<td>' . $procedureDetails['139'] . '</td>
<td>' . $procedureDetails['140'] . '</td>
</tr>
<tr>
...
<tr>
<td>' . $procedureDetails['141'] . '</td>
<td>' . $procedureDetails['142'] . '</td>
<td>' . $procedureDetails['143'] . '</td>
</tr>
</table>
    <br>
    ...
    foreach ($sections as $section) {
        $html .= '<th colspan="' . $section->total_section_details . '">' . $section->name . '<br>' . calculateSectionDate($section->day_number, 130) . '</th>';
    }
