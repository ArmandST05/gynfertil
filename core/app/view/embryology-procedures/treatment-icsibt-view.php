      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="date" id="dt-130" name="details[130]" class="form-control" placeholder="Fecha de aspiración folicular" value="<?php echo $procedureDetails['130'] ?>" required>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Aspiración - Estradiol:</label>
            <input type="text" id="dt-131" name="details[131]" class="form-control" placeholder="Aspiración - Estradiol" value="<?php echo $procedureDetails['131'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Progesterona:</label>
            <input type="text" id="dt-146" name="details[146]" class="form-control" placeholder="Progesterona" value="<?php echo $procedureDetails['146'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Beta Hcg:</label>
            <input type="text" id="dt-132" name="details[132]" class="form-control" placeholder="Beta Hcg" value="<?php echo $procedureDetails['132'] ?>">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[135]" value="1" <?php echo ($procedureDetails['135'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[135]" value="0" <?php echo ($procedureDetails['135'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[136]" value="1" <?php echo ($procedureDetails['136'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[136]" value="0" <?php echo ($procedureDetails['136'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-134" name="details[134]" class="form-control" placeholder="Id donante semen" value="<?php echo $procedureDetails['134'] ?>" readonly>
          </div>
        </div>-->
      </div>
      <hr>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="number" min="0" id="dt-147" name="details[147]" class="form-control" placeholder="Cantidad de folículos" min="0" value="<?php echo $procedureDetails['147'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Óvulos recuperados:</label>
            <input type="number" min="0" id="dt-137" name="details[137]" class="form-control" placeholder="Óvulos recuperados" min="0" value="<?php echo $procedureDetails['137'] ?>" required <?php echo ($procedureDetails['137'] != "" && $procedureDetails['137'] != 0) ? "readonly" : "" ?>>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">MI:</label>
            <input type="number" min="0" id="dt-138" name="details[138]" class="form-control" placeholder="MI" value="<?php echo $procedureDetails['138'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">MII:</label>
            <input type="number" min="0" id="dt-139" name="details[139]" class="form-control" placeholder="MII" value="<?php echo $procedureDetails['139'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Vesícula germinal:</label>
            <input type="number" min="0" id="dt-140" name="details[140]" class="form-control" placeholder="Vesícula germinal" value="<?php echo $procedureDetails['140'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Degenerado:</label>
            <input type="number" min="0" id="dt-141" name="details[141]" class="form-control" placeholder="Degenerado" value="<?php echo $procedureDetails['141'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecundación-Ovocitos inseminados:</label>
            <input type="number" min="0" id="dt-142" name="details[142]" class="form-control" placeholder="Fecundación-Ovocitos inseminado" value="<?php echo $procedureDetails['142'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecundación - Fertilizados:</label>
            <input type="number" min="0" id="dt-143" name="details[143]" class="form-control" placeholder="Fecundación - Fertilizados" value="<?php echo $procedureDetails['143'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <thead>
            <tr>
              ...
              <?php foreach ($sections as $section) :
                $sectionDate = "";
                if (isset($procedureDetails['130']) && $procedureDetails['130'] != "0000-00-00" && $section->day_number != "" &&  $section->day_number >= 0) {
                  $sectionDate = date("d/m/Y", strtotime($procedureDetails['130'] . " +" . $section->day_number . " days"));
                }
              ?>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" id="dt-144" name="details[144]" class="form-control" placeholder="No viables" value="0" readonly>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-483" name="details[483]" class="form-control" value="<?php echo $procedureDetails['483'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad B:</label>
            <input type="text" id="dt-484" name="details[484]" class="form-control" value="<?php echo $procedureDetails['484'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad C:</label>
            <input type="text" id="dt-485" name="details[485]" class="form-control" value="<?php echo $procedureDetails['485'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad D:</label>
            <input type="text" id="dt-486" name="details[486]" class="form-control" value="<?php echo $procedureDetails['486'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-487" name="details[487]" class="form-control" value="<?php echo $procedureDetails['487'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Calidad embrionaria:</label>
            <input type="text" id="dt-488" name="details[488]" class="form-control" value="<?php echo $procedureDetails['488'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Mórulas:</label>
            <input type="text" id="dt-489" name="details[489]" class="form-control" value="<?php echo $procedureDetails['489'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Detenidos:</label>
            <input type="text" id="dt-490" name="details[490]" class="form-control" value="<?php echo $procedureDetails['490'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-491" name="details[491]" class="form-control" value="<?php echo $procedureDetails['491'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7 - Calidad embrionaria:</label>
            <input type="text" id="dt-492" name="details[492]" class="form-control" value="<?php echo $procedureDetails['492'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7 - Mórulas:</label>
            <input type="text" id="dt-493" name="details[493]" class="form-control" value="<?php echo $procedureDetails['493'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7- Detenidos:</label>
            <input type="text" id="dt-494" name="details[494]" class="form-control" value="<?php echo $procedureDetails['494'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Observaciones:</label>
            <input type="text" id="dt-496" name="details[496]" class="form-control" value="<?php echo $procedureDetails['496'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="checkbox" id="imagesList">
            <?php
            $arraySelectedImages = explode(",", $procedureDetails['495']);
            foreach ($ovuleImages as $ovuleImage) :
            ?>
              <label id="lblImageList<?php echo $ovuleImage->procedure_ovule_id ?>">
                <input name="details[495][]" id="details[495]" type="checkbox" value="<?php echo $ovuleImage->procedure_ovule_id ?>" <?php echo (in_array($ovuleImage->procedure_ovule_id, $arraySelectedImages)) ? "checked" : "" ?>>
...
<script>
              ...
              preConfirm: (value) => {
                ...
                $.ajax({
                  ...
                  success: function(data) {
                    ...
                    let htmlImageList = '<label id="lblImageList' + procedureOvuleId + '"><input name="details[495][]" id="details[495]" type="checkbox" value="' + procedureOvuleId + '"><a href="' + data + '" target="_blank" class="btn btn-default btn-sm"><i class="fas fa-image"></i>' + procedureOvuleCode + '</a></label>';
  ...
  function updateProcedureDetails() {
    let totalOvulesRecovered = $("#dt-137").val();
    if ("<?php echo $procedureDetails['137'] ?>" == '' || "<?php echo $procedureDetails['137'] ?>" == 0) {
      Swal.fire({
