...
try {
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['438']);
    ...
    //Obtener los detalles de las donadoras de óvulos
    $donorOvuleCodesArray = [];
    $procedureOvules = PatientOvuleData::getOvulesByProcedureSectionId($embryologyProcedureId, 1);
    foreach ($procedureOvules as $ovule) {
        $donorOvuleCodesArray[$ovule->getOriginPatientTreatment()->getPatient()->donor_id] = $ovule->getOriginPatientTreatment()->getPatient()->donor_id;
    }
    $donorCodes = implode(",", $donorOvuleCodesArray);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">RECEPTORA DE ÓVULOS</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">ASPIRACIÓN FOLICULAR <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['53']) . ')</span></th>
        <td rowspan="5">';
    ...
    $html .= '</td></tr> 
        <tr>
            ...
            <td width="150px" class="underlined center">' . $procedureDetails['60'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MI:</td>
            <td class="underlined center">' . $procedureDetails['61'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en MII:</td>
            <td class="underlined center">' . $procedureDetails['62'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Óvulos en VG:</td>
            <td class="underlined center">' . $procedureDetails['63'] . '</td>
        </tr>
        <tr>
            <td class="content-title">Degenerados:</td>
            <td class="underlined center">' . $procedureDetails['64'] . '</td>
        </tr>
    <tr>
    <th class="title" colspan="3">FERTILIZACIÓN <span class="date-title">(' . calculateSectionDate(1, 53) . ')</span></th>
    <td rowspan="7">';
    ...
    <tr>
        ...
        <td  width="150px" class="underlined center">' . $procedureDetails['65'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Óvulos fertilizados:</td>
        <td class="underlined center">' . $procedureDetails['66'] . '</td>
    </tr>
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 3 <span class="date-title">(' . calculateSectionDate(3, 53) . ')</span></th>
</tr>
    <tr>
        <td width="200px" class="content-title">Embriones calidad A:</td>
        <td  width="150px" class="underlined center">' . $procedureDetails['426'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad B:</td>
        <td class="underlined center">' . $procedureDetails['427'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad C:</td>
        <td class="underlined center">' . $procedureDetails['428'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad D:</td>
        <td class="underlined center">' . $procedureDetails['429'] . '</td>
    </tr>
</table>
<table width="100%">
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 5 <span class="date-title">(' . calculateSectionDate(5, 53) . ')</span></th>
    <td rowspan="9">';
    ...
    <tr>
        ...
        <td width="150px" class="underlined center">' . $procedureDetails['430'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['431'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['432'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['433'] . '</td>
    </tr>
    <tr>
        <th class="title" colspan="3">EVALUACIÓN DÍA 6 Y 7 <span class="date-title">(' . calculateSectionDate(6, 53) . ' - ' . calculateSectionDate(7, 53) . ')</span></th>
    </tr>
    <tr>
        <td width="200px" class="content-title">Blastocistos:</td>
        <td width="150px" class="underlined center">' . $procedureDetails['434'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['435'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['436'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['437'] . '</td>
    </tr>
...
<table width="50%">
    <tr>
    <td width="200px" class="content-title">Código donadora de óvulos:</td>
    <td width="150px" class="underlined center">' . $donorCodes . '</td>
    <td width="150px"></td>
</tr>
    </table>
...
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['439'] . '</td>
</tr>
</table>
...
<table class="patient-details">';
    foreach ($arrayOvuleImages as $ovuleImages) {
        ...
        $html .= '</tr>
        <tr>';
        foreach ($ovuleImages as $ovuleImage) {//#' . $ovuleImage->getProcedureOvule()->procedure_code . '
            $html .= '<th width="250px" class="title-image"><br></th>';
        }
        $html .= '</tr>';
    }
    $html .= '</table>';
