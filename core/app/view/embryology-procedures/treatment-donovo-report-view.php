...
try {
    ...
    <table width="100%">
        <tr>
            ...
            <td class="title-document">DONACIÓN DE ÓVULOS <br>' . $embryologyProcedure->treatment_code . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
    ...
    <tr class="title">
        <th>Ciclo</th>
        <th>Código donadora</th>
        <th>Fecha de aspiración folicular</th>
        <th>Aspiración - Estradiol</th>
        <th>Consentimiento femenino</th>
    </tr>';
    $femaleConsent = (($procedureDetails['109'] == 1) ? "Sí" : "No");
    $html .= '
    <tr>
    <td>' . $actualCycle . '</td>
    <td>' . $patient->donor_id  . '</td>
    <td>' . $embryologyProcedure->getDateMonthFormat($procedureDetails['107']) . '</td>
    <td>' . $procedureDetails['108'] . '</td>
    <td>' . $femaleConsent . '</td>
</tr>
<tr class="title">
...
<tr>
<td colspan="2">' . $treatmentDiagnostics . '</td>
<td>' . $procedureDetails['110'] . '</td>
<td>' . $procedureDetails['111'] . '</td>
<td>' . $procedureDetails['112'] . '</td>
</tr>
<tr>
...
<tr>
<td>' . $procedureDetails['113'] . '</td>
<td>' . $procedureDetails['114'] . '</td>
</tr>
</table>
    <br>
    ...
    foreach ($procedureOvules as $ovule) {
        ...
        $html .= '<td>' . (($ovule->end_ovule_status_id == 6) ? "X" : "") . '</td>
