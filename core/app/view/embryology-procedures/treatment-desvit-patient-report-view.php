...
try {
    ...
    $selectedImagesPath = [];
    /*$selectedOvulesImages = explode(",", $procedureDetails['424']);
    ...
    <table width="100%">
        <tr>
            <th class="title-document" align="center">DESVITRIFICACIÓN DE ÓVULOS</th>
        </tr>
    </table>
    <table width="100%">
        <tr>
    ...
    <table width="100%">
    <tr>
        <th class="title" colspan="3">ASPIRACIÓN FOLICULAR <span class="date-title">(' . ConfigurationData::getDateFormat($procedureDetails['117']) . ')</span></th>
        <td rowspan="6">';
    ...
    $html .= '</td></tr> 
        <tr>
            <td width="100px" class="content-title">Óvulos desvitrificados:</td>
            <td width="150px" class="underlined center">' . $procedureDetails['124'] . '</td>
            <td width="150px"></td>
        </tr>
        <tr>
            <td class="content-title">Degenerados:</td>
            <td class="underlined center">' . $procedureDetails['125'] . '</td>
            <td></td>
        </tr>
    <tr>
    <th class="title" colspan="3">FERTILIZACIÓN <span class="date-title">(' . calculateSectionDate(1, 117) . ')</span></th></tr> 
    <tr>
        <td width="200px" class="content-title">Óvulos inseminados:</td>
        <td  width="150px" class="underlined center">' . $procedureDetails['126'] . '</td>
        <td width="150px"></td>
    </tr>
    <tr>
        <td class="content-title">Óvulos fertilizados:</td>
        <td class="underlined center">' . $procedureDetails['127'] . '</td>
    </tr>
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 3 <span class="date-title">(' . calculateSectionDate(3, 117) . ')</span></th>
</tr>
    <tr>
        <td width="200px" class="content-title">Embriones calidad A:</td>
        <td  width="150px" class="underlined center">' . $procedureDetails['412'] . '</td>
        <td width="150px" ></td>
        <td rowspan="6">';
    ...
    <tr>
        ...
        <td class="underlined center">' . $procedureDetails['413'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad C:</td>
        <td class="underlined center">' . $procedureDetails['414'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Embriones calidad D:</td>
        <td class="underlined center">' . $procedureDetails['415'] . '</td>
    </tr>
<tr>
    <th class="title" colspan="3">EVALUACIÓN DÍA 5 <span class="date-title">(' . calculateSectionDate(5, 117) . ')</span></th>
    </tr> 
    <tr>
        <td width="200px" class="content-title">Blastocistos:</td>
        <td width="150px" class="underlined center">' . $procedureDetails['416'] . '</td>
        <td width="150px" ></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['417'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['418'] . '</td>
        <td rowspan="6">';
    ...
    <tr>
        ...
        <td class="underlined center">' . $procedureDetails['419'] . '</td>
    </tr>
    <tr>
        <th class="title" colspan="3">EVALUACIÓN DÍA 6 Y 7 <span class="date-title">(' . calculateSectionDate(6, 117) . ' - ' . calculateSectionDate(7, 117) . ')</span></th>
    </tr>
    <tr>
        <td width="200px" class="content-title">Blastocistos:</td>
        <td width="150px" class="underlined center">' . $procedureDetails['420'] . '</td>
        <td width="150px" ></td>
    </tr>
    <tr>
        <td class="content-title">Calidad embrionaria:</td>
        <td class="underlined center">' . $procedureDetails['421'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Mórulas:</td>
        <td class="underlined center">' . $procedureDetails['422'] . '</td>
    </tr>
    <tr>
        <td class="content-title">Detenidos:</td>
        <td class="underlined center">' . $procedureDetails['423'] . '</td>
    </tr>
</table>
<br>
<table width="100%">
<tr>
    ...
    <td width="600px" class="underlined">' . $procedureDetails['425'] . '</td>
</tr>
</table>
