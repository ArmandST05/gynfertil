...
try {
    ...
    <table width="100%">
        <tr>
            ...
            <td class="title-document">PGTA <br>' . $embryologyProcedure->treatment_code . '</td>
        </tr>
    </table>
    <br>
    <table width="100%">
    ...
    <td>' . $embryologyProcedure->getDateMonthFormat($procedureDetails['81']) . '</td>
    <td>' . $procedureDetails['82'] . '</td>
    <td>' . $procedureDetails['83'] . '</td>
</tr>
<tr class="title">
    <th>Beta Hcg</th>
    <th>Consentimiento femenino</th>
    <th>Consentimiento masculino</th>
    <th colspan="2">Consentimiento PGTA</th>
</tr>
<tr>
<td>' . $procedureDetails['84'] . '</td>';
    $femaleConsent = (($procedureDetails['87'] == 1) ? "Sí" : "No");
    $maleConsent = (($procedureDetails['88'] == 1) ? "Sí" : "No");
    $pgtaConsent = (($procedureDetails['89'] == 1) ? "Sí" : "No");
    $html .= '<td>' . $femaleConsent . '</td>
<td>' . $maleConsent . '</td>
<td colspan="2">' . $pgtaConsent . '</td>
</tr>
<tr class="title">
<th colspan="2">Diagnóstico</th>
<th colspan="3">Semen</th>
</tr>
<tr>
...
<tr>
<td>' . $procedureDetails['90'] . '</td>
<td>' . $procedureDetails['91'] . '</td>
<td>' . $procedureDetails['92'] . '</td>
<td>' . $procedureDetails['93'] . '</td>
<td>' . $procedureDetails['94'] . '</td>
</tr>
<tr class="title">
    <th>Degenerado</th>
...
<tr>
<td>' . $procedureDetails['95'] . '</td>
<td>' . $procedureDetails['96'] . '</td>
<td>' . $procedureDetails['97'] . '</td>
</tr>
</table>
    <br>
    ...
    foreach ($sections as $section) {
        $html .= '<th colspan="' . $section->total_section_details . '">' . $section->name . '<br>' . calculateSectionDate($section->day_number, 81) . '</th>';
    }
    ...
    foreach ($procedureOvules as $ovule) {
        ...
        if ($ovule->end_ovule_status_id == 2 && $endOvulePhaseId == 2) {
