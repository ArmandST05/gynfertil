<?php
/*-------------DONADORA DE EMBRIONES (EMBRIODON) (13)----------*/
?>
  ...
  <div class="box-body">
    <form method="POST" action="index.php?action=embryology-procedures/updateProcedure" role="form">
      <div class="row">
        ...
        <div class="col-md-4">
          <label for="inputEmail1" class="control-label">Consentimiento de donación de embriones:
            <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Consentimiento que firma la paciente que dona sus embriones"></i>
          </label>
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[77]" value="1" <?php echo ($procedureDetails['77'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[77]" value="0" <?php echo ($procedureDetails['77'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <label for="inputEmail1" class="control-label">Consentimiento de recepción de embriones donados:
            <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Consentimiento que firman los pacientes que van a recibir embriones donados"></i>
          </label>
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[78]" value="1" <?php echo ($procedureDetails['78'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[78]" value="0" <?php echo ($procedureDetails['78'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Ciclos de procedencia de embriones:</label>
            <input type="text" id="dt-79" name="details[79]" class="form-control" placeholder="Ciclos de procedencia de embriones" value="" readonly>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <table id="ovulesDataTable" class="cell-border compact" style="width:100%">
          <thead>
            <tr>
              ...
              <?php endforeach; ?>
              <th rowspan="2">PROCEDIMIENTO DESTINO</th>
            ...
            ?>
              <tr class="origin-treatment" data-origin-treatment-code="<?php echo $ovule->getOriginPatientTreatment()->treatment_code; ?>" data-procedure-ovule-id="<?php echo $ovule->id ?>" data-section-phase-id="<?php echo ($ovule->end_ovule_phase_id) ? $ovule->end_ovule_phase_id : $ovule->initial_ovule_phase_id ?>" data-procedure-ovule-code="<?php echo $ovule->procedure_code ?>">
                ...
                <?php foreach ($ovuleSectionDetailValues as $ovuleValue) : ?>
                  <td data-section-detail-id="<?php echo $ovuleValue->ovule_section_detail_id ?>" data-procedure-ovule-id="<?php echo $ovule->id ?>" id="<?php echo $ovule->id . '-' . $ovuleValue->ovule_section_detail_id ?>" style="background-color:<?php echo (($ovuleValue->ovule_section_detail_id == '102' && $ovuleValue->value != '') ? '' . $ovuleValue->value : '#FFFFFF'); ?>">
                    <?php if ($ovuleValue->ovule_section_detail_id != '102') {
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" id="dt-129" name="details[129]" class="form-control" placeholder="No viables" value="0" readonly>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-475" name="details[475]" class="form-control" value="<?php echo $procedureDetails['475'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día de cultivo descongelación:</label>
            <input type="text" id="dt-476" name="details[476]" class="form-control" value="<?php echo $procedureDetails['476'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Calidad embrionaria descongelación:</label>
            <input type="text" id="dt-477" name="details[477]" class="form-control" value="<?php echo $procedureDetails['477'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Total embriones transferidos:</label>
            <input type="text" id="dt-478" name="details[478]" class="form-control" value="<?php echo $procedureDetails['478'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día de cultivo transferencia:</label>
            <input type="text" id="dt-479" name="details[479]" class="form-control" value="<?php echo $procedureDetails['479'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Calidad embrionaria transferencia:</label>
            <input type="text" id="dt-480" name="details[480]" class="form-control" value="<?php echo $procedureDetails['480'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Observaciones:</label>
            <input type="text" id="dt-482" name="details[482]" class="form-control" value="<?php echo $procedureDetails['482'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="checkbox" id="imagesList">
            <?php
            $arraySelectedImages = explode(",", $procedureDetails['481']);
            foreach ($ovuleImages as $ovuleImage) :
            ?>
              <label id="lblImageList<?php echo $ovuleImage->procedure_ovule_id ?>">
                <input name="details[481][]" id="details[481]" type="checkbox" value="<?php echo $ovuleImage->procedure_ovule_id ?>" <?php echo (in_array($ovuleImage->procedure_ovule_id, $arraySelectedImages)) ? "checked" : "" ?>>
    ...
    <div id="embryoTransferDetails">
      <form method="POST" action="index.php?action=embryology-procedures/updateTransferDetail" role="form">
        <div class="row">
          <div class="col-md-3">
            <div class="form-group">
              <label for="inputEmail1" class="control-label">Fecha de Transferencia de embriones donados:</label>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="number" id="embryoTransferTotal" name="total" min="1" required class="form-control" placeholder="Total Transferidos" value="<?php echo $transferDetail->total ?>" autofocus>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select id="embryoTransferGynecologist" name="gynecologist" class="form-control">
                <?php if ($userType == "su" || $userType == "sub" || $userType == "r") : ?>
              ...
              preConfirm: (value) => {
                ...
                $.ajax({
                  ...
                  success: function(data) {
                    ...
                    let htmlImageList = '<label id="lblImageList' + procedureOvuleId + '"><input name="details[481][]" id="details[481]" type="checkbox" value="' + procedureOvuleId + '"><a href="' + data + '" target="_blank" class="btn btn-default btn-sm"><i class="fas fa-image"></i>' + procedureOvuleCode + '</a></label>';
