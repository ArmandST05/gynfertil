      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-1" name="details[1]" class="form-control" placeholder="Ciclo" value="<?php echo $actualCycle ?>" readonly>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecha de estimulación:</label>
            <input type="text" id="dt-18" name="details[18]" class="form-control" placeholder="Fecha de estimulación" value="<?php echo $embryologyProcedure->getDateMonthFormat($embryologyProcedure->start_date) ?>" readonly>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecha de aspiración folicular:</label>
            <input type="date" id="dt-2" name="details[2]" class="form-control" placeholder="Fecha de aspiración folicular" value="<?php echo $procedureDetails['2'] ?>" required>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Aspiración - Estradiol:</label>
            <input type="text" id="dt-3" name="details[3]" class="form-control" placeholder="Aspiración - Estradiol" value="<?php echo $procedureDetails['3'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Progesterona:</label>
            <input type="text" id="dt-19" name="details[19]" class="form-control" placeholder="Progesterona" value="<?php echo $procedureDetails['19'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Beta Hcg:</label>
            <input type="text" id="dt-4" name="details[4]" class="form-control" placeholder="Beta Hcg" value="<?php echo $procedureDetails['4'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[7]" value="1" <?php echo ($procedureDetails['7'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[7]" value="0" <?php echo ($procedureDetails['7'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          ...
          <div class="form-group">
            <div class="radio">
              <label>
                <input type="radio" name="details[8]" value="1" <?php echo ($procedureDetails['8'] == 1) ? "checked" : "" ?>>Sí
              </label>
              <label>
                <input type="radio" name="details[8]" value="0" <?php echo ($procedureDetails['8'] == 0) ? "checked" : "" ?>>No
              </label>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <!--<div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" id="dt-6" name="details[6]" class="form-control" placeholder="Id donante semen" value="<?php echo $procedureDetails['6'] ?>" readonly>
          </div>
        </div>-->
      </div>
      <hr>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="number" min="0" id="dt-20" name="details[20]" class="form-control" placeholder="Cantidad de folículos" min="0" value="<?php echo $procedureDetails['20'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Óvulos recuperados:</label>
            <input type="number" min="0" id="dt-10" name="details[10]" class="form-control" placeholder="Óvulos recuperados" min="0" value="<?php echo $procedureDetails['10'] ?>" required <?php echo ($procedureDetails['10'] != "" && $procedureDetails['10'] != 0) ? "readonly" : "" ?>>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">MI:</label>
            <input type="number" min="0" id="dt-11" name="details[11]" class="form-control" placeholder="MI" value="<?php echo $procedureDetails['11'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">MII:</label>
            <input type="number" min="0" id="dt-12" name="details[12]" class="form-control" placeholder="MII" value="<?php echo $procedureDetails['12'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Vesícula germinal:</label>
            <input type="number" min="0" id="dt-13" name="details[13]" class="form-control" placeholder="Vesícula germinal" value="<?php echo $procedureDetails['13'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Degenerado:</label>
            <input type="number" min="0" id="dt-14" name="details[14]" class="form-control" placeholder="Degenerado" value="<?php echo $procedureDetails['14'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecundación-Ovocitos inseminados:</label>
            <input type="number" min="0" id="dt-15" name="details[15]" class="form-control" placeholder="Fecundación-Ovocitos inseminado" value="<?php echo $procedureDetails['15'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Fecundación - Fertilizados:</label>
            <input type="number" min="0" id="dt-16" name="details[16]" class="form-control" placeholder="Fecundación - Fertilizados" value="<?php echo $procedureDetails['16'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <thead>
            <tr>
              ...
              <?php foreach ($sections as $section) :
                $sectionDate = "";
                if (isset($procedureDetails['2']) && $procedureDetails['2'] != "0000-00-00" && $section->day_number != "" &&  $section->day_number >= 0) {
                  $sectionDate = date("d/m/Y", strtotime($procedureDetails['2'] . " +" . $section->day_number . " days"));
                }
              ?>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" id="dt-17" name="details[17]" class="form-control" placeholder="No viables" value="0" readonly>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-398" name="details[398]" class="form-control" value="<?php echo $procedureDetails['398'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad B:</label>
            <input type="text" id="dt-399" name="details[399]" class="form-control" value="<?php echo $procedureDetails['399'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad C:</label>
            <input type="text" id="dt-400" name="details[400]" class="form-control" value="<?php echo $procedureDetails['400'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Embriones calidad D:</label>
            <input type="text" id="dt-401" name="details[401]" class="form-control" value="<?php echo $procedureDetails['401'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-402" name="details[402]" class="form-control" value="<?php echo $procedureDetails['402'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Calidad embrionaria:</label>
            <input type="text" id="dt-403" name="details[403]" class="form-control" value="<?php echo $procedureDetails['403'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Mórulas:</label>
            <input type="text" id="dt-404" name="details[404]" class="form-control" value="<?php echo $procedureDetails['404'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 5 - Detenidos:</label>
            <input type="text" id="dt-405" name="details[405]" class="form-control" value="<?php echo $procedureDetails['405'] ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" id="dt-406" name="details[406]" class="form-control" value="<?php echo $procedureDetails['406'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7 - Calidad embrionaria:</label>
            <input type="text" id="dt-407" name="details[407]" class="form-control" value="<?php echo $procedureDetails['407'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7 - Mórulas:</label>
            <input type="text" id="dt-408" name="details[408]" class="form-control" value="<?php echo $procedureDetails['408'] ?>">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Día 6 y 7- Detenidos:</label>
            <input type="text" id="dt-409" name="details[409]" class="form-control" value="<?php echo $procedureDetails['409'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <label for="inputEmail1" class="control-label">Observaciones:</label>
            <input type="text" id="dt-411" name="details[411]" class="form-control" value="<?php echo $procedureDetails['411'] ?>">
          </div>
        </div>
        <div class="col-md-12">
          <div class="checkbox" id="imagesList">
            <?php
            $arraySelectedImages = explode(",", $procedureDetails['410']);
            foreach ($ovuleImages as $ovuleImage) :
            ?>
              <label id="lblImageList<?php echo $ovuleImage->procedure_ovule_id ?>">
                <input name="details[410][]" id="details[410]" type="checkbox" value="<?php echo $ovuleImage->procedure_ovule_id ?>" <?php echo (in_array($ovuleImage->procedure_ovule_id, $arraySelectedImages)) ? "checked" : "" ?>>
...
<script>
  ...
  function updateProcedureDetails() {
    let totalOvulesRecovered = $("#dt-10").val();
    if ("<?php echo $procedureDetails['10'] ?>" == '' || "<?php echo $procedureDetails['10'] ?>" == 0) {
      Swal.fire({
  ...
  function saveSelectedAndrologyProcedure() {
    ...
    $('#selectAndrologyProcedure').val(null).trigger('change');
  }
