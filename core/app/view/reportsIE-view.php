    ...
    $(document).ready(function() {
        ...
        $("#btnExport").click(function(e) {
            ...
            $("#datosexcel").btechco_excelexport({
                ...
                filename: 'Reporte Ingresos y Egresos'
            });
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form>
                <input type="hidden" name="view" value="reportsIE">
                <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            $curr_sell = SellData::getAllSellFechas($f1, $f2);
            ...
            ?>
                ...
                <table class="table table-bordered table-hover" id='datosexcel' border='1'>
                    ...
                    foreach ($curr_sell as $sell) {
                        ...
                        $tBa = "";
                        $tot += $sell->total;
                        $typeP = OperationData::getAllBySellPay($sell->id);
                        echo "<tr class='$t'>
            ...
            $curr_sellP = SellData::getAllSellFechasP($f1, $f2);
            ...
            $curr_sell = SellData::getAllExpFechas($f1, $f2);
            ...
            $curr_sellP = SellData::getAllExpFechasP($f1, $f2);
