...
<div class="btn-group  pull-right">
	<a href="index.php?view=newconceptspend" class="btn btn-default">Agregar concepto</a>
</div>
				...
				var dataTable = $('#lookup1').DataTable( {
				 ...
				 "language":	{
					...
					"ajax":{
						...
						url :"./?action=conceptspend", // json datasource
  ...
  function confirmar() {
                   var flag = confirm("¿Seguro quedeseas eliminar el producto?");
                   if(flag==true){
                       return true;
                   }else{
                       return false;
