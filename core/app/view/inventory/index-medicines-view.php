...
<div class="row">
	<div class="col-md-12">
		<div class="btn-group  pull-right">
			<a href="index.php?view=products/new" class="btn btn-default">Agregar producto/medicamento</a>
		</div>
		...
		<table id="lookup1" class="table table-bordered table-hover">
			...
			<tbody bgcolor="#eeeeee" align="center">
			</tbody>
		</table>
	...
	$(document).ready(function() {
		var dataTable = $('#lookup1').DataTable({
			...
			"ajax": {
				...
				url: "./?action=inventory/get-all-medicines", // json datasource
