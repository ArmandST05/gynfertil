		...
		<form method="post" action="index.php?action=inventory/add-output-product" autocomplete="off">
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
						<br>
						<input type="hidden" name="branchOfficeId" value="<?php echo $branchOfficeId ?>"></input>
		...
		<table class="table table-bordered table-hover" style="width:675px;">
			...
			?>
				<tr>
					...
					<td style="width:30px;"><a href="index.php?action=inventory/delete-output-cart&productId=<?php echo $product->id; ?>&branchOfficeId=<?php echo $branchOfficeId ?>" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
				</tr>
		...
		<form method="post" class="form-horizontal" action="index.php?action=inventory/add-output">
			<div class="form-group">
				...
				<div class="col-lg-10 pull-right">
					...
					<input type="hidden" name="branchOfficeId" value="<?php echo $branchOfficeId ?>">
				</div>
			</div>
		</form>
	<?php endif; ?>
